...
Simply include the URL for a PDF document on it's own line, or wrapped in the embed tag like `[embed]https://github.com/VinodhThiagarajan1309/apachestormrealtime/blob/master/Storm.pdf[/embed]` and the plugin will embed the PDF into the page using the Google Docs Viewer embed code.
